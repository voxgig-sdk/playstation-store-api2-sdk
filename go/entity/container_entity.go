...
type ContainerEntity struct {
	name    string
	client  *core.PlaystationStoreApi2SDK
...
func NewContainerEntity(client *core.PlaystationStoreApi2SDK, entopts map[string]any) *ContainerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContainerEntity) GetName() string { return e.name }
...
func (e *ContainerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContainerEntity) Deleted() bool {
	return e.deleted
}


func (e *ContainerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContainerEntity(e.client, opts)
}

func (e *ContainerEntity) Data(args ...any) any {
...
func (e *ContainerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Container; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContainerEntity) DataTyped(data ...Container) Container {
	if len(data) > 0 {
		return typedFrom[Container](e.Data(asMap(data[0])))
	}
	return typedFrom[Container](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Container (all fields
// optional at the wire level).
func (e *ContainerEntity) MatchTyped(match ...Container) Container {
	if len(match) > 0 {
		return typedFrom[Container](e.Match(asMap(match[0])))
	}
	return typedFrom[Container](e.Match())
}
...
func (e *ContainerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContainerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContainerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContainerListMatch and returns []Container. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContainerEntity) ListTyped(reqmatch ContainerListMatch, ctrl map[string]any) ([]Container, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Container](res), nil
}



func (e *ContainerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContainerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContainerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContainerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
