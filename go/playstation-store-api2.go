...
// instead of `sdk.NewPlaystationStoreApi2SDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PlaystationStoreApi2SDK  { return NewPlaystationStoreApi2SDK(nil) }
func Test() *PlaystationStoreApi2SDK { return TestSDK(nil, nil) }
