# PlaystationStoreApi2 Ruby SDK

The Ruby SDK for the PlaystationStoreApi2 API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
gem "playstation-store-api2-sdk"
```
...
result, err = client.PlaystationStoreApi2(nil).load(
  { "id" => "test01" }, nil
)
...
```ruby
client = PlaystationStoreApi2SDK.test(testopts, sdkopts)
```
...
```
rb/
├── PlaystationStoreApi2_sdk.rb       -- Main SDK module
...
The main module (`PlaystationStoreApi2_sdk`) exports the SDK class
