...
## Install
```bash
gem install voxgig-sdk-playstation-store-api2
```

Or add to your `Gemfile`:

```ruby
gem "voxgig-sdk-playstation-store-api2"
```
...
```ruby
result, err = client.Container().list
raise err if err
...
result, err = client.PlaystationStoreApi2().load({ "id" => "test01" })
