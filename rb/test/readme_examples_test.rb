...
#      offline in seeded test mode (PlaystationStoreApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PlaystationStoreApi2_sdk.rb")
  SDK_CLASS = "PlaystationStoreApi2SDK"
  ...
  SDK_BASE = "PlaystationStoreApi2_sdk"
