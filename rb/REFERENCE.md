# PlaystationStoreApi2 Ruby SDK Reference

Complete API reference for the PlaystationStoreApi2 Ruby SDK.
...
#### `PlaystationStoreApi2SDK.test(testopts = nil, sdkopts = nil)`
...
| --- | --- | --- | --- |
| `age_limit` | `Integer` | No | Age limit for the content |
| `attributes` | `Hash` | No |  |
| `container_type` | `String` | No | Type of container |
| `content_origin` | `Integer` | No | Content origin identifier |
