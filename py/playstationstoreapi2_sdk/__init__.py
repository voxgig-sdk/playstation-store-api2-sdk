...
from playstationstoreapi2_sdk.utility import register

# Load features
from playstationstoreapi2_sdk.feature.base_feature import PlaystationStoreApi2BaseFeature
from playstationstoreapi2_sdk.features import _has_feature, _make_feature
...
class PlaystationStoreApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PlaystationStoreApi2Utility()
    ...
    def get_utility(self):
        return PlaystationStoreApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PlaystationStoreApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Container(self, data=None) -> "ContainerEntity":
        ...
        from playstationstoreapi2_sdk.entity.container_entity import ContainerEntity
