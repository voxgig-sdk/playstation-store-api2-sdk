# PlaystationStoreApi2 Python SDK Reference

Complete API reference for the PlaystationStoreApi2 Python SDK.
...
#### `PlaystationStoreApi2SDK.test(testopts=None, sdkopts=None)`
...
```python
results, err = client.Container().list({})
```
