...
from playstationstoreapi2_types import (
    Container,
    ContainerListMatch,
)
...
class ContainerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContainerEntity(self._client, opts)
    ...
    def list(self, reqmatch: ContainerListMatch, ctrl=None) -> list[Container]:
