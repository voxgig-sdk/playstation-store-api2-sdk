# PlaystationStoreApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PlaystationStoreApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PlaystationStoreApi2SDK(...) and PlaystationStoreApi2SDK.test(...) become
#      PlaystationStoreApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "playstationstoreapi2_sdk"
_SDK_CLASS = "PlaystationStoreApi2SDK"
