# PlaystationStoreApi2 PHP SDK

The PHP SDK for the PlaystationStoreApi2 API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Container(null)->list(null, null);
...
[$result, $err] = $client->PlaystationStoreApi2(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── playstationstoreapi2_sdk.php          -- Main SDK class
...
The main class (`playstationstoreapi2_sdk.php`) exports the SDK class
