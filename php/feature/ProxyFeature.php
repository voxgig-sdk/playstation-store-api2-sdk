...
// PlaystationStoreApi2 SDK proxy feature
...
class PlaystationStoreApi2ProxyFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    public function init(PlaystationStoreApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PlaystationStoreApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
