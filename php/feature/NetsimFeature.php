...
// PlaystationStoreApi2 SDK netsim feature
...
class PlaystationStoreApi2NetsimFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _simulate(PlaystationStoreApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PlaystationStoreApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
