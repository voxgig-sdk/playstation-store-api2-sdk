...
// PlaystationStoreApi2 SDK telemetry feature
...
class PlaystationStoreApi2TelemetryFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _close(PlaystationStoreApi2Context $ctx, bool $ok): void
    {
