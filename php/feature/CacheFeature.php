...
// PlaystationStoreApi2 SDK cache feature
...
class PlaystationStoreApi2CacheFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _through(PlaystationStoreApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
