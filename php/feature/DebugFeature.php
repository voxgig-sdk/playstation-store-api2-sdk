...
// PlaystationStoreApi2 SDK debug feature
...
class PlaystationStoreApi2DebugFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _finish(PlaystationStoreApi2Context $ctx, bool $ok): void
    {
