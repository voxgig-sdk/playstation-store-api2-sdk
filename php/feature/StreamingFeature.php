...
// PlaystationStoreApi2 SDK streaming feature
...
class PlaystationStoreApi2StreamingFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _iterate(PlaystationStoreApi2Result $result): \Generator
    {
    ...
    private function _streamable(PlaystationStoreApi2Context $ctx): bool
    {
