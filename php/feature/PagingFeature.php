...
// PlaystationStoreApi2 SDK paging feature
...
class PlaystationStoreApi2PagingFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _is_list(PlaystationStoreApi2Context $ctx): bool
    {
