...
// PlaystationStoreApi2 SDK idempotency feature
...
class PlaystationStoreApi2IdempotencyFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _mutating(PlaystationStoreApi2Context $ctx): bool
    {
