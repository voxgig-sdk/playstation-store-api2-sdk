...
// PlaystationStoreApi2 SDK ratelimit feature
...
class PlaystationStoreApi2RatelimitFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _acquire(PlaystationStoreApi2Context $ctx): void
    {
    ...
    private function _track(PlaystationStoreApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
