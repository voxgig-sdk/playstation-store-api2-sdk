...
// PlaystationStoreApi2 SDK utility: graphql
//
...
class PlaystationStoreApi2Graphql
{
    ...
    // equivalent.
    public static function body(PlaystationStoreApi2Context $ctx): mixed
    {
    ...
    public static function errors(PlaystationStoreApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
