...
class ContainerEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PLAYSTATION_STORE_API2_TEST_CONTAINER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function container_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PLAYSTATION_STORE_API2_TEST_CONTAINER_ENTID");
