...
// PlaystationStoreApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PlaystationStoreApi2SDK::test)
...
{
    private const SDK_CLASS = 'PlaystationStoreApi2SDK';
    ...
    private const SDK_BASE = 'playstationstoreapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../playstationstoreapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
