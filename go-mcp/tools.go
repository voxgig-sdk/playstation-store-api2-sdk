...
type Args struct {
	Entity string         `json:"entity" jsonschema:"container"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PlaystationStoreApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "playstation-store-api2_list",
		Description: "List records from PlaystationStoreApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "playstation-store-api2_load",
		Description: "Load a single record from PlaystationStoreApi2. " +
...
func runOp(client *sdk.PlaystationStoreApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PlaystationStoreApi2SDK, name string) (sdk.PlaystationStoreApi2Entity, error) {
