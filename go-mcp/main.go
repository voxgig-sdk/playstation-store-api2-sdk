// Command PlaystationStoreApi2-mcp is an MCP server exposing the PlaystationStoreApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PlaystationStoreApi2_list  — list records of an entity
//	PlaystationStoreApi2_load  — load a single record of an entity
//
