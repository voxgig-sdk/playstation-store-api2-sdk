...
AQL-driven CLI and REPL for the PlaystationStoreApi2 SDK. Positional arguments are
...
```sh
go build -o playstation-store-api2-cli ./...
```
...
./playstation-store-api2-cli load '{id:1}' container
