...
func registerSDKWords(r *eng.Registry, client *sdk.PlaystationStoreApi2SDK) {
...
func runOp(client *sdk.PlaystationStoreApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
