# PlaystationStoreApi2 SDK feature corpus test
#
...
def _client(kase):
    ...
    PlaystationStoreApi2SDK(...), not PlaystationStoreApi2SDK.test(...): the `test` feature is
    ...
    return PlaystationStoreApi2SDK(opts)
