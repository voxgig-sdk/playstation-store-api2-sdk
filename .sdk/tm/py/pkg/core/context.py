...
from projectname_sdk.core.control import PlaystationStoreApi2Control
...
class PlaystationStoreApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PlaystationStoreApi2Control()
        ...
        if isinstance(sp, PlaystationStoreApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PlaystationStoreApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PlaystationStoreApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PlaystationStoreApi2Operation({})
    ...
    def make_error(self, code, msg):
        return PlaystationStoreApi2Error(code, msg, self)
