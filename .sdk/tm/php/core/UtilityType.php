...
// PlaystationStoreApi2 SDK utility type

class PlaystationStoreApi2Utility
{
    ...
    public static function copy(PlaystationStoreApi2Utility $src): PlaystationStoreApi2Utility
    {
        $u = new PlaystationStoreApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
