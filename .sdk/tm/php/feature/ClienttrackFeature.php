...
// PlaystationStoreApi2 SDK clienttrack feature
...
class PlaystationStoreApi2ClienttrackFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    public function PostConstruct(PlaystationStoreApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PlaystationStoreApi2-SDK';
