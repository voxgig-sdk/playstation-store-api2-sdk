...
// PlaystationStoreApi2 SDK rbac feature
...
class PlaystationStoreApi2RbacFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _required(PlaystationStoreApi2Context $ctx): ?string
    {
    ...
    private function _reject(PlaystationStoreApi2Context $ctx, string $required): void
    {
    ...
    private function _track(PlaystationStoreApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
