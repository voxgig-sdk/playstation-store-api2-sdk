...
// PlaystationStoreApi2 SDK audit feature
...
class PlaystationStoreApi2AuditFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _emit(PlaystationStoreApi2Context $ctx, string $outcome): void
    {
