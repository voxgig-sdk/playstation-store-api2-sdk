...
// PlaystationStoreApi2 SDK metrics feature
...
class PlaystationStoreApi2MetricsFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _record(PlaystationStoreApi2Context $ctx, bool $ok): void
    {
