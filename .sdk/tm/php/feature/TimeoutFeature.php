...
// PlaystationStoreApi2 SDK timeout feature
...
class PlaystationStoreApi2TimeoutFeature extends PlaystationStoreApi2BaseFeature
{
    ...
    private function _with_timeout(PlaystationStoreApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PlaystationStoreApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
